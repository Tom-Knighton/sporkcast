...
let package = Package(
    ...
    dependencies: [.package(path: "../Design"), .package(path: "../API"), .package(path: "../Environment"), .package(path: "../Persistence"), .package(path: "../Models"), .package(path: "../RecipeImporting")],
    targets: [
        // Targets are the basic building blocks of a package, defining a module or a test suite.
        // Targets can depend on other targets in this package and products from dependencies.
        .target(
            name: "Recipe",
            dependencies: ["Design", "API", "Environment", "Persistence", "RecipeImporting"],
            swiftSettings: BuildFlags.betaSDKSwiftSettings
        ),
        .testTarget(
            name: "RecipeTests",
            dependencies: ["Recipe", "Design", "Persistence", "Models", "RecipeImporting"],
            swiftSettings: BuildFlags.betaSDKSwiftSettings
        )
    ],
)
